# ![LOGO](logo.png) AWS Shield MSP Connector

## Description

A generated MSP connector for the AWS Shield API (version 2016-06-02).
...
flowground :- Telekom iPaaS / amazonaws-com-shield-connector<br/>
